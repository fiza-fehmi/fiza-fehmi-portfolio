  ...
  return (
    <div style={{ display:"flex", minHeight:"100vh", alignItems:"center", justifyContent:"center", background:"#050505", color:"#f5f5f5" }}>
      <div style={{ textAlign:"center" }}>
        ...
        <Link to="/" style={{ marginTop:"1.5rem", display:"inline-block", color:"#A259FF" }}>Go home</Link>
      </div>
    </div>
  );
}
    ...
    <div style={{ display:"flex", minHeight:"100vh", alignItems:"center", justifyContent:"center", background:"#050505", color:"#f5f5f5" }}>
      <div style={{ textAlign:"center" }}>
        ...
        <div style={{ marginTop:"1.5rem", display:"flex", gap:"0.5rem", justifyContent:"center" }}>
          <button onClick={() => { router.invalidate(); reset(); }} style={{ padding:"0.5rem 1rem", background:"#A259FF", color:"#050505", borderRadius:"0.5rem", border:"none", cursor:"pointer", fontWeight:600 }}>Try again</button>
          <a href="/" style={{ padding:"0.5rem 1rem", border:"1px solid rgba(255,255,255,0.15)", borderRadius:"0.5rem", color:"#f5f5f5", textDecoration:"none" }}>Go home</a>
        </div>
      </div>
    </div>
  );
